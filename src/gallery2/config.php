 ...
 */
$gallery->setConfig('setup.password', 'j@ck2olo');
 ...
 */
$gallery->setConfig('data.gallery.base', '/var/www/webapps/scc/g2data/');
...
$storeConfig['database'] = 'scc';
$storeConfig['username'] = 'sccuser';
$storeConfig['password'] = 'j@ck2olo';
$storeConfig['schema'] = '';
 ...
 */
$gallery->setConfig('baseUri', 'http://scc.kapow.com/gallery2/main.php');
?>
