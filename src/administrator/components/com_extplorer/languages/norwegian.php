<?php
// $Id: $
// Norwegian Language Module for v2.3 (translated by Bj&ouml;rnar Markussen)
global $_VERSION;
...
$GLOBALS["error_msg"] = array(
	...
	"abovehome"		=> "Den aktuelle katalogen kan ikke v&auml;re over hjemkatalogen.",
	"targetabovehome"	=> "M&aring;lkatalogen kan ikke være ovenfor hjemkatalogen.",
	...
	"targetdoesexist"	=> "M&aring;lobjektet finnes allerede.",
	"targetexist"		=> "M&aring;lkatalogen finnes ikke.",

	// open
	"opendir"		=> "Katalogen kan ikke &aring;pnes.",
	...
	"accesstarget"	=> "Du har ikke tillatelse til &aring;ning av m&aring;lkatalogen.",
	...
	"openfile"		=> "Kan ikke &aring;pne filen.",
	...
	"searchnothing"	=> "S&ouml;ketema m&aring; angis.",

	// misc
	"miscnofunc"		=> "Funksjonen er ikke tilgjengelig.",
	"miscfilesize"	=> "Filen overskrider maksimal st&ouml;rrelse.",
	"miscfilepart"	=> "Filen ble bare delvis lastet opp.",
	"miscnoname"		=> "Du m&aring; angi et navn.",
	"miscselitems"	=> "Du har ikke valgt objekt.",
	"miscdelitems"	=> "Er du helt sikker p&aring; at du vil slette disse {0} objektene?",
	"miscdeluser"		=> "Er du helt sikker p&aring; at du vil slette brukeren '{0}'?",
...
$GLOBALS["messages"] = array(
	...
	'logolink'		=> 'G&aring; til websiden for joomlaXplorer (&aring;pnes i nytt vindu)', // new mic

	// list
	"nameheader"		=> "Navn",
	"sizeheader"		=> "St&ouml;rrelse",
	"typeheader"		=> "Type",
	"modifheader"		=> "Endret",
	"permheader"		=> "Rettigheter",
	"actionheader"	=> "Hendelser",
	"pathheader"		=> "S&ouml;kesti",
	...
	'success_rename_file' => 'Katalogen/filen %s ble omd&ouml;pt til %s.',
	...
	"actlogin"		=> "Logg inn",
	"actloginheader"	=> "Logg inn for &aring; bruke eXtplorer",
	...
	'siphpupdate'		=> 'INFORMASJON: <span style="color: red;">PHP-versjonen du bruker er<strong>ikke</strong> gjeldende!</span><br />For &aring; garantere at alle funksjoner og muligheter skal fungera,<br />b&ouml;r du bruke minst <strong>PHP-versjon 4.3</strong>!',
	...
	'sibasedir'		=> '&aring;pne basismappe',
	...
	'sidisabledfuncs'	=> 'Funksjoner avsl&aring;tt',
	...
	'sidirpermsmess'	=> 'For å være sikker p&aring; at alle funksjoner og muligheter i eXtplorer skal fungere korrekt, skal f&ouml;lgende kataloger ha skrivr&auml;ttigheter [chmod 0777]',
	...
	'recurse_subdirs'	=> 'Bruk p&aring; underkataloger?',
	
	// added by Paulino Michelazzo (paulino@michelazzo.com.br) to footer.php file
	'check_version'	=> 'Kontrollere om det finnes oppdateringer',
	
	// added by Paulino Michelazzo (paulino@michelazzo.com.br) to fun_rename.php file
	'rename_file'		=> 'Bytt navn p&aring; katalog eller fil...',
	'newname'		=> 'Nytt navn',
	...
	'ftp_connection_failed' => "Det gikk ikke &aring; kopple opp mot FTP-serveren. \nKontroller om FTP-serveren kj&ouml;rer p&aring; din server.",
	'ftp_login_failed' 	=> "FTP-innloggingen feilet. Kontrollere brukernavn og passord og pr&ouml;v igjen.",
		
	'switch_file_mode' => 'N&aring;værende modus er [%s] <br /> Endre til [%s] modus.',
	'symlink_target' => 'M&aring;l for Symbolic Link',
	
	"permchange"		=> "CHMOD vellykket:",
	"savefile"		=> "Filen ble lagret.",
	"moveitem"		=> "Flytting vellykket.",
	"copyitem"		=> "Kopiering vellykket.",
	'archive_name' 	=> 'Navn p&aring; arkivfil',
	...
	'actlogin_failure' 	=> 'Innlogging mislykket, pr&ouml;v igjen.',
	'directory_tree' 	=> 'Katalogtre',
	'browsing_directory' => 'Bla i katalogen',
	'filter_grid' 	=> 'Filter',
	'paging_page' 	=> 'Side',
	'paging_of_X' 	=> 'av {0}',
	'paging_firstpage' 	=> 'F&ouml;rste side',
	'paging_lastpage' 	=> 'Siste side',
	'paging_nextpage' 	=> 'Neste side',
	'paging_prevpage' 	=> 'Forrige side',
	
	'paging_info' 	=> 'Vis objekt {0} - {1} av {2}',
	'paging_noitems' 	=> 'Intet objekt &aring; vise',
	'aboutlink' 		=> 'Om...',
	'password_warning_title' 	=> 'Viktig - endre passordet ditt!',
	'password_warning_text'	=> 'Brukerkontoen du logget inn med (admin med passord admin) er standardkontoen for administratorer i eXtplorer. Din eXtplorer-installasjon ligger &aring;pen for angrep og du m&aring; derfor umiddelbart endre / fjerne detta sikkerhetshullet. Bytt passord n&aring;!',
	...
	'acttransfer' 	=> 'Overf&ouml;re filer fra en annen server',
	'transfer_processing' => 'Prossesserer opplasting fra Server-til-Server, vennligst vent...',
	'transfer_completed' => 'Overf&ouml;ring ferdig!',
	'max_file_size' 	=> 'Maximal filst&ouml;rrelse',
	'max_post_size' 	=> 'Maximal opplastingsst&ouml;rrelse',
	'done' 		=> 'Ferdig.',
	'permissions_processing' => 'Setter rettigheter, vennligst vent...',
	'archive_created' 	=> 'Arkivfilen er laget!',
	'save_processing' 	=> 'Lagrer fil...',
	'current_user' 	=> 'Detta skriptet kj&ouml;rer n&aring; med rettigheter for f&ouml;lgende brukere:',
	'your_version' 	=> 'Din versjon',
	'search_processing' 	=> 'S&ouml;ker, vennligst vent...',
