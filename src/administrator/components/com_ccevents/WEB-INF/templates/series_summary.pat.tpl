<mos:comment>
/**
 *  $Id$: series_summary.php, Oct 13, 2006 5:28:33 PM nchanda
...
<mos:tmpl name="series_summary">
  <form action="index2.php" method="post" name="adminForm">
		<table class="adminheading">
		<tr>
			<th>Series Manager</th>
		</tr>
		</table>
		...
		<mos:tmpl name="series" autoclear="yes">
			<tr class="row{ITER}">
				<td>{INDEX}.</td>
				<td align="center">
  				...
  				<td align="left">
  					<a href="index2.php?option=com_ccevents&scope=sers&task=read&oid={OID}">{NAME}</a>
  				</td>
  				<td align="center">
