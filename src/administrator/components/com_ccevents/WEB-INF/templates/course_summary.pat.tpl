<mos:comment>
/**
 *  $Id$: course_summary.pat.tpl, Aug 19, 2006 3:00:20 PM nchanda
...
<mos:tmpl name="course_summary">
  <form action="index2.php" method="post" name="adminForm">
		...
		<mos:tmpl name="course" autoclear="yes">
			<tr class="row{ITER}">
				<td>{INDEX}.</td>
				<td align="center">
  				...
  				<td align="left">
  					<a href="index2.php?option=com_ccevents&scope=crse&task=read&oid={OID}">{TITLE}</a>
  				</td>
  				<td align="center">
