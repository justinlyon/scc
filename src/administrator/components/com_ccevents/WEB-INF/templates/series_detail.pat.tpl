<mos:comment>
/**
 *  $Id$: series_detail.pat.tpl, Sep 5, 2006 8:43:25 PM nchanda
...
<mos:tmpl name="series_detail">
	<mos:tmpl name="includes" src="includes.pat.tpl" relative="yes"/>

	<fieldset>
	<legend>Series Manager:&nbsp;{NAME}</legend>
	<form action="index2.php" method="post" name="adminForm">
		...
		<tr>
			...
			<div class="c1_form">
			<ul>
				<li class="first"><label class="req">Series Name:</label><input id="name" name="name" type="text" class="text" value="{NAME}"/></li>
				...
				<li><label class="textarea">Series Description:</label><br/>
					{DESC_EDITOR}
				</li>	
			</ul>
			</div>
