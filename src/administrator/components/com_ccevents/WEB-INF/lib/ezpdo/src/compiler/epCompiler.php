...
/**
 * $Id: epCompiler.php 979 2006-05-22 12:13:53Z nauhygon $
 * 
 * Copyright(c) 2005 by Oak Nauhygon. All rights reserved.
 * 
 * @author Oak Nauhygon <ezpdo4php@gmail.com>
 * @version $Revision$ $Date: 2006-05-22 08:13:53 -0400 (Mon, 22 May 2006) $
 * @package ezpdo
...
class epClassCompiler extends epConfigurableWithLog {
    ...
    protected function prepareOutputDir() {
        ...
        if (!file_exists($compiled_dir)) {
            // true: recursive (see http://www.php.net/manual/en/function.mkdir.php)
            if (!mkdir($compiled_dir, 0700, true)) {
