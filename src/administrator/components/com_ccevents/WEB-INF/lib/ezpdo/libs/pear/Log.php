<?php
// $Id: Log.php 189 2005-04-17 17:38:00Z nauhygon $
...
if (!defined('PEAR_LOG_ALL')) {define('PEAR_LOG_ALL',      bindec('11111111'));}  /** All messages */
if (!defined('PEAR_LOG_NONE')) {define('PEAR_LOG_NONE',     bindec('00000000'));}  /** No message */

/* Log types for PHP's native error_log() function. */
if (!defined('PEAR_LOG_TYPE_SYSTEM')) {define('PEAR_LOG_TYPE_SYSTEM',  0);} /** Use PHP's system logger */
if (!defined('PEAR_LOG_TYPE_MAIL')) {define('PEAR_LOG_TYPE_MAIL',    1);} /** Use PHP's mail() function */
if (!defined('PEAR_LOG_TYPE_DEBUG')) {define('PEAR_LOG_TYPE_DEBUG',   2);} /** Use PHP's debugging connection */
if (!defined('PEAR_LOG_TYPE_FILE')) {define('PEAR_LOG_TYPE_FILE',    3);} /** Append to a file */
