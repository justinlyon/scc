...
<?php
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_ccevents&scope=prgm&task=edit&cid[]='. $row->eoid );
?>
