...
/**
 * J!Dump
 * @version      $Id: changelog.php 31 2008-04-28 14:46:40Z jenscski $
...
2009-08-30
  # Added missing dump.js to manifest (to repair window locking)
  # Updated documentation to show correct names for backtrace and template params functions
  # Added aliases for backtrace and template params functions
